...
<div class="container">
  ...
  <div class="modal fade" tabindex="-1" role="dialog" id="editar">
    <div class="modal-dialog" role="document">
      ...
      <form action="<?php echo base_url()?>careas/editar" method="post">
        <div class="row">
          <div class="col-xs-7">
            <div class="form-group">
            <input type="text" value="" class="hidden" id="id" name="id">
              <label>
                Nombre del área:
              </label> 
              <input name="txtNombresele" class="form-control" placeholder="Nombre del área" id="nombreArea">
            </div>
          </div>
          </div>
           <div class="row">
            <div class="col-xs-12">
              ...
              <textarea name="txtDescripcionsele" class="form-control" rows="5" placeholder="Descripción" id="descripcion"></textarea>
              </div>
            </div>
          </div>
          <div class="row">
          <div class="col-xs-7">
            <div class="form-group">
              ...
              <input name="txtResponsablesele" class="form-control" placeholder="Responsable del área" id="responsable">
            </div>
          </div>
      ...
      <div align="right">
          <input type="submit" class="btn btn-default" value="Guardar" name="">
          <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
      </div>
      <!--<?php //validation_errors();?>-->
    </form>
