  ...
  <div class="container">
  <p id="profile-name" class="profile-name-card" ><h1 align="center">Regístrarse</h1></p>
        <div class="card card-container">
            <img id="profile-img" class="profile-img-card" src="<?php echo base_url();?>assets/img/avatar.png" />
            <form  action="<?php echo base_url();?>clogin/ingresar" method="post" accept-charset="utf-8" class="login" name="txtusuario" autocomplete="off" role="form" class="form-signin">
